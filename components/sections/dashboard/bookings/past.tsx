    ...
    <div className="flex flex-col gap-4">
      {bookings.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 bg-n-7 rounded-lg border border-n-12">
          ...
          <p className="text-n-3 font-medium">No past bookings</p>
          <p className="text-n-4 text-sm mt-1">Your completed appointments will appear here</p>
        </div>
      ) : (
